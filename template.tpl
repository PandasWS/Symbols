...
<html>
	<head>
		<title>PandasWS Symbol Server - {{html .Name}}</title>
		<meta charset="utf-8">
...
@media (max-width: 600px) {
	...
	<body onload='filter()'>
		...
		<footer>
			Served with <a rel="noopener noreferrer" href="https://caddyserver.com" target="_blank">Caddy</a> Crafted with love by <a rel="noopener noreferrer" href="https://pandas.ws" target="_blank">PandasWS</a>
		</footer>
		<script>
